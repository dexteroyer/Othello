...
class Evaluator(object):
    WIPEOUT_SCORE = 1000  # The move that results a player losing all pieces
    ...
    def get_piece_differential(self, deltaBoard, band):
        """This returns the piece differential score. Given a board resultant of the
    ...
    def get_corner_differential(self, deltaCount, deltaBoard, band):
        """This returns the corner differential score. Given a board resultant of
    ...
    def get_edge_differential(self, deltaCount, deltaBoard, band):
        ...
        opponent.  A-squares are (c1, f1, a3, a6, h3, h6, c8, f8).
        B-squares are (d1, e1, a4, a5, h4, h5, d8, e8).
    ...
    def get_xsquare_differential(self, startBoard, currentBoard, deltaBoard, band):
        """ This returns the difference of x-squares owned between the players
    ...
    def get_potential_mobility_differential(self, startBoard, currentBoard, band):
        """ This returns the difference between opponent and player number of frontier pieces.
        startBoard - board before the move
        currentBoard - board after the move
        band - weight
        """
    ...
    def get_mobility_differential(self, startBoard, currentBoard, band):
        """ This returns the difference of number of valid moves between the player and his opponent.
        startBoard - board before the move
        currentBoard - board after the move
        band - weight
        """
    ...
    def score(self, startBoard, board, currentDepth, player, opponent):
        ...
        # Determine the weigths according to the number of pieces
