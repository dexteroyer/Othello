...
class Board:
    ...
    def get_valid_moves(self, color):
        ...
        search for pieces of the other color to determine if it is
    ...
    def apply_move(self, move, color):
        """ Determine if the move is correct or not and apply the changes in the game.
        """
    ...
    def flip(self, direction, position, color):
        """ This flips (capturates) the pieces of the given color in the given direction
        ...
        if i in range(8) and j in range(8) and self.board[i][j] == other:
            # This assures there is at least one piece to flip.
            places = places + [(i, j)]
            i = i + row_inc
            j = j + col_inc
    ...
    def get_changes(self):
        """ This returns black and white counters. """
    ...
    def game_ended(self):
        ...
        # No more valid moves for both players.
    ...
    def count_stones(self):
        """ This returns the number of white pieces, black pieces and empty squares, in
        this order.
        """
        whites = 0
        blacks = 0
